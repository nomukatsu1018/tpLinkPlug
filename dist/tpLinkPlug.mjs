...
var en$1 = {
	...
	"tpLinkPlug.entry.description": "Description of this extension"
};
var ja$1 = {
	"tpLinkPlug.entry.name": "TP-Link Plug",
	"tpLinkPlug.entry.description": "拡張機能の説明"
};
var translations$1 = {
	en: en$1,
	ja: ja$1,
	"ja-Hira": {
	"tpLinkPlug.entry.name": "TP-Link Plug",
	"tpLinkPlug.entry.description": "かくちょうきのうのせつめい"
}
};
...
var extensionURL = 'https://nomukatsu1018.github.io/xcx-tplink-plug/dist/tpLinkPlug.mjs';
/**
      ...
      return new Promise(function (resolve) {
        fetch(req).then(function (res) {
          if (res.ok) {
            ...
            resolve("".concat(res.status, ":\n                        ").concat(res.statusText, ", URL: ").concat(req.url));
          }
